SRCPATH = src
OBJPATH = obj
CFLAGS = -Wall -fpic -ffreestanding -fno-stack-protector -nostdinc -nostdlib -no-pie -g
...
kernel:
	...
	ld --no-relax -n -o kernel.bin -T linker.ld obj/main64.o obj/boot.o obj/mbootheader.o obj/kernel.o
